...
use leptos_meta::*;
use montrs_core::{
    AppConfig, AppSpec, EnvConfig, EnvError, Plate, PlateContext, RouteView,
    Router, RouterOutlet, Target,
};
use montrs_icons::*;
        ...
        <header class="border-b border-border">
            <div class="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
                ...
                <nav class="flex items-center gap-4">
                    <a href="https://opencode.ai" class="text-sm text-muted-foreground transition-colors hover:text-foreground">
                        "Docs"
                    </a>
                    <button on:click=move |_| toggle_theme() class="rounded-md p-2 transition-colors hover:bg-accent" aria-label="Toggle theme">
                        {move || {
        ...
        <section class="py-24 text-center">
            <div class="mx-auto max-w-4xl px-6">
                ...
                <div class="mt-10 flex items-center justify-center gap-4">
                    <a href="https://opencode.ai" class="inline-flex items-center gap-2 rounded-md bg-primary px-6 py-3 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/90">
                        "Get Started"
                        <ArrowRightIcon class="h-4 w-4" />
                    </a>
                    <a href="https://github.com/anomalyco/montrs" class="inline-flex items-center gap-2 rounded-md border border-border px-6 py-3 text-sm font-medium transition-colors hover:bg-accent">
        ...
        <section class="py-16">
            <div class="mx-auto max-w-6xl px-6">
                ...
                <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                    <FeatureCard title="Type-Safe Architecture" description="Build with confidence using MontRS's explicit architecture patterns." />
                    <FeatureCard title="Reactive by Default" description="Powered by Leptos signals. Every component is reactive and efficient." />
                    <FeatureCard title="SQL-First ORM" description="Backend-agnostic, SQL-first database abstraction layer." />
                    <FeatureCard title="Built-in Validation" description="Compile-time validation with proc macros." />
                    <FeatureCard title="Beautiful UI Components" description="Shadcn-inspired components with Tailwind CSS and dark mode." />
                    <FeatureCard title="Developer Experience" description="Hot reload, CLI tools, agents, and CI/CD integration." />
                </div>
            </div>
        </section>
    }
