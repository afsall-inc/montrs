        ...
        <section class="py-24 text-center">
            <div class="mx-auto max-w-4xl px-6">
                ...
                <div class="mt-10 flex items-center justify-center gap-4">
                    <a href="/docs" class="inline-flex items-center gap-2 rounded-md bg-primary px-6 py-3 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/90">
                        "Get Started"
        ...
        <section class="py-16">
            <div class="mx-auto max-w-6xl px-6">
                ...
                <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                    <FeatureCard title="Shared Components" description="Reusable UI components defined in packages/ui, consumed by all apps in the workspace." />
                    <FeatureCard title="Unified Config" description="Workspace-level Cargo.toml manages shared dependencies, versions, and settings." />
                    <FeatureCard title="Consistent Theming" description="Dark/light mode, Tailwind CSS variables, and design tokens shared across all apps." />
                </div>
            </div>
        </section>
    }
