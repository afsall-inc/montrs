...
#[component]
pub fn AnimatedIcons() -> impl IntoView {
    ...
    view! {
        <div class="mx-auto max-w-6xl px-6 py-12 lg:px-8">
            <div class="mb-8">
                <h1 class="text-3xl font-bold">"Animated Icons"</h1>
                <p class="mt-2 text-muted-foreground">
                    {move || format!("{} icons — hover to play animation", Glyph::count())}
                </p>
            </div>
            ...
            <div class="mb-8 flex flex-wrap gap-4">
                <input
                    ...
                    on:input={
                        ...
                        nav(&format!("/animated-icons?search={}", val), Default::default());
                    }}
                />
                <select
                    ...
                    on:change={
                        ...
                        let val = event_target_value(&e);
                        size.set(val.clone());
                        nav(&format!("/animated-icons?size={}", val), Default::default());
                    }}
                >
                    ...
                    children=move |glyph| {
                        ...
                        view! {
                            <button
                                ...
                                title=name.clone()
                            >
                                <AnimatedIcon glyph=Signal::from(glyph) class=icon_size() />
                    ...
                    >
                        ...
                        >
                            <div class="flex justify-center mb-4">
                                <AnimatedIcon glyph=Signal::from(glyph) class="w-16 h-16" attr:style="color: var(--icon-color)" />
                            </div>
