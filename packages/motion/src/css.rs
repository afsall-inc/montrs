...
pub fn css_transition(properties: &[&str], duration: &str, easing: &str) -> String {
    properties
        .iter()
...
pub const SLIDE_UP: &str = "transform 0.3s cubic-bezier(0.16, 1, 0.3, 1), opacity 0.2s ease";
...
pub fn gpu_transform(translate_x: f64, translate_y: f64, scale: f64, rotate: f64) -> String {
    format!(
